...
<img
        src="https://readme-typing-svg.herokuapp.com/?size=30&width=800&lines=Click+On+The+ace+bot+image+To+Install+The+Bot."
            alt="Typing SVG"
        />
    </a>
</p>
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/RICHUSER007/Queen-Alexa)
# ```ALEXA-BUG-BOT```
<p align="center">
...
- Owner number [Here](https://github.com/RICHUSER007/ACE-BOT/blob/main/settings.json#L4)
- Owner Name [Here](https://github.com/RICHUSER007/ACE-BOT/blob/main/settings.json#L14)
- Bot Name [Here](https://github.com/RICHUSER007/ACE-BOT/blob/main/settings.json#L15)
